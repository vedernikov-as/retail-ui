  ...
  describe("vertical", function () {
    ...
    it("clicked", async function () {
      ...
      await this.browser.actions({
        ...
        origin: this.browser.findElement(By.css("[data-comp-name=\"RadioGroup\"] > span > label"))
      }).click(this.browser.findElement(By.css("[data-comp-name=\"RadioGroup\"] > span > label"))).perform();
    ...
    it("mouseLeave", async function () {
      ...
      await this.browser.actions({
        ...
        origin: this.browser.findElement(By.css("[data-comp-name=\"RadioGroup\"] > span > label"))
      }).click(this.browser.findElement(By.css("[data-comp-name=\"RadioGroup\"] > span > label"))).click(this.browser.findElement(By.css("[data-tid=\"JustButton\"]"))).perform();
    ...
    it("tabPress", async function () {
      ...
      await this.browser.actions({
        ...
        origin: this.browser.findElement(By.css("[data-comp-name=\"RadioGroup\"] > span > label"))
      }).click(this.browser.findElement(By.css("[data-comp-name=\"RadioGroup\"] > span > label"))).click(this.browser.findElement(By.css("[data-tid=\"JustButton\"]"))).sendKeys(Key.TAB).perform();
    ...
    it("arrow_down", async function () {
      ...
      await this.browser.actions({
        ...
        origin: this.browser.findElement(By.css("[data-comp-name=\"RadioGroup\"] > span > label"))
      }).click(this.browser.findElement(By.css("[data-comp-name=\"RadioGroup\"] > span > label"))).click(this.browser.findElement(By.css("[data-tid=\"JustButton\"]"))).sendKeys(Key.TAB).sendKeys(Key.DOWN).perform();

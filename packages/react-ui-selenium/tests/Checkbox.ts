  ...
  describe("plain", function () {
    ...
    it("clicked", async function () {
      ...
      await this.browser.actions({
        ...
        origin: this.browser.findElement(By.css("span"))
      }).click(this.browser.findElement(By.css("span"))).perform();
    ...
    it("mouseLeave", async function () {
      ...
      await this.browser.actions({
        ...
        origin: this.browser.findElement(By.css("span"))
      }).click(this.browser.findElement(By.css("span"))).click(this.browser.findElement(By.css("body"))).perform();
    ...
    it("tabPress", async function () {
      ...
      await this.browser.actions({
        ...
        origin: this.browser.findElement(By.css("span"))
      }).click(this.browser.findElement(By.css("span"))).click(this.browser.findElement(By.css("body"))).sendKeys(Key.TAB).perform();
    ...
    it("spacePress", async function () {
      ...
      await this.browser.actions({
        ...
        origin: this.browser.findElement(By.css("span"))
      }).click(this.browser.findElement(By.css("span"))).click(this.browser.findElement(By.css("body"))).sendKeys(Key.TAB).sendKeys(Key.SPACE).perform();
  ...
  describe("indeterminate", function () {
    ...
    it("tabPress", async function () {
      ...
      await this.browser.actions({
        ...
        origin: this.browser.findElement(By.css("label"))
      }).click(this.browser.findElement(By.css("body"))).sendKeys(Key.TAB).perform();
      await expect((await element.takeScreenshot())).to.matchImage("tabPress");
    });
  });
